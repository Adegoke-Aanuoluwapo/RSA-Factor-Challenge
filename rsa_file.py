...
n = p * q as formular is given here... we have n +ve will try fxn/p (math logic)
c = 65537

#
plaintext = flag

message = bytes_to_bite(plaintext) #this is for encripting ... revrse this
